...
class Blog extends Model{
    ...
    function All()
    {
        $query = "select blog_id, blog_title, blog_image, blog_content, author_email from $this->table where active = 1 ORDER BY $this->contents DESC";
    ...
    public function getAllProducts(){
        $sql = "SELECT product_name , product_id FROM products WHERE product_status = 1 LIMIT 100";
        return pdo_query($sql);
    }
