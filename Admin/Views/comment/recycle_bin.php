...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-primary delete-button"
                    href="?mod=comment&act=back_up&id=<?= htmlspecialchars($comment['comment_id']) ?>">back up</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            confirmDeleteLink.href = `?mod=comment&act=force_delete&id=${commentId}`;
        });
    });
});
</script>