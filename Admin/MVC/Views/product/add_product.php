...
<div class="col-md-12">
    ...
    // var_dump($category);
    ?>
    <form action="?mod=product&act=insert_product" method="POST" enctype="multipart/form-data"> <!-- enctype="multipart/form-data" vi khi phuong thuc gui file phai co cau lenh nay --> 
        <div class="row">
            <div class="col-md-6">
